...
- [x] Aufgabe 3: Handy mit Fotos platzieren
- [x] Aufgabe 5: Becher mit farbiger Flüssikeit füllen
- [x] Aufgabe 6: verschlossene Schere + Puzzleteile unterm Stuhl platzieren + Stuhl markieren
- [x] Aufgabe 7: Aufschnittbox in Küche oder Flur platzieren
...
Die Superheldinnen sind bereits eingestimmt. Bunte Umhänge und Augenmasken sind verteilt und die Superheldinnen-Kostüme weiter gebastelt.
...
Darauf ist eine Nachricht von Tingel Tangel John den Fernseher einzuschalten, auf der Rückseite ist **eine geheimnisvolle Karte (Grundriss Erdgeschoss)**.
Der Fernseher wird eingeschaltet...es startet eine Sondersendung der Tagesschau...
https://youtu.be/7oeTZBNC9gY
...
- das Papier hat die gleiche Größe wie das Blatt auf dem die Botschaft kam
- die Kreise markieren 3 Stellen (Vase, Spielküche, Waschbecken WC)
  - versteckt sind 3 x Korken mit Holzspießen
...
- es gibt 3 mit Konfetti gefüllte Luftballons, die zwischen anden Ballons an der Decke hängen. Auf denen steht 
  ...
  - Lina
  - 7
- die müssen mit den Spießen und großem Effekt kaputt gemacht werden 
- hier sind je 2 Puzzleteile drin von einem Entsperrmuster eines Handys
...
- Aufschrift: Biohazard und ACHTUNG ÄTZEND!!! ACHTUNG nicht ausschütten
- Schlüssel liegt unten in grüner Flüssigkeit (Wasser mit Lebensmittelfarbe)
- der Becher hat ein seitliches Loch
- Superheldinnen müssen drauf kommen den Schlüssel mit dem Magnet aus dem Becher zu holen.
...
- darin sind 3 Umschläge:
  - **2 Finalpuzzleteile**
  - und zwei Matheaufgaben:
    - Zahlen zu Bildern (Telefone) bestimmen Vorwahl 
...
- unter dem Blumentopf unserer Zier-Orangen liegt ein Briefumschlag
- mit einem Schlüssel und Hinweis auf den nächsten Ort: "der nächste Ort ist alt, dunkel und schwer"
*Was könnte das sein* --> unsere große Truhe im Wohnzimmer, die mit einem Schloss verschlossen ist

## Aufgabe 9: Enigma Verschlüsselungsmaschine
- hier ist eine Stärkung für alle Heldinnen enthalten (Goldtaler)
